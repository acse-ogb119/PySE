...
def solve(T=1.0, n=1000, m=100,tolerance=1.0e-3, relativeconv=True):
    ...
    # in implicit case, the first computed solution is at t=dt
    rt = dt
    ...
    laps = -time.time()
    while rt < T:
        u = conjgrad(A,u,u,tolerance,relativeconv)
